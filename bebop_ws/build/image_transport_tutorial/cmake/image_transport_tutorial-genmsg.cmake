...
set(MSG_I_FLAGS "-Iimage_transport_tutorial:/home/robot/bebop_ws/src/image_transport_tutorial/msg;-Isensor_msgs:/opt/ros/indigo/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/indigo/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/robot/bebop_ws/src/image_transport_tutorial/msg/ResizedImage.msg" NAME_WE)
add_custom_target(_image_transport_tutorial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "image_transport_tutorial" "/home/robot/bebop_ws/src/image_transport_tutorial/msg/ResizedImage.msg" "std_msgs/Header:sensor_msgs/Image"
)
...
_generate_msg_cpp(image_transport_tutorial
  "/home/robot/bebop_ws/src/image_transport_tutorial/msg/ResizedImage.msg"
  "${MSG_I_FLAGS}"
...
### Generating Messages
_generate_msg_java(image_transport_tutorial
  "/home/robot/bebop_ws/src/image_transport_tutorial/msg/ResizedImage.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/indigo/share/std_msgs/cmake/../msg/Header.msg;/opt/ros/indigo/share/sensor_msgs/cmake/../msg/Image.msg"
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/image_transport_tutorial
)

### Generating Services

### Generating Module File
_generate_module_java(image_transport_tutorial
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/image_transport_tutorial
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(image_transport_tutorial_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(image_transport_tutorial_generate_messages image_transport_tutorial_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/robot/bebop_ws/src/image_transport_tutorial/msg/ResizedImage.msg" NAME_WE)
add_dependencies(image_transport_tutorial_generate_messages_java _image_transport_tutorial_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(image_transport_tutorial_genjava)
add_dependencies(image_transport_tutorial_genjava image_transport_tutorial_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS image_transport_tutorial_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/image_transport_tutorial)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/image_transport_tutorial
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
add_dependencies(image_transport_tutorial_generate_messages_java sensor_msgs_generate_messages_java)
