...
execute_process(
  COMMAND "/usr/bin/git" show-ref ARSDK3_version_3_6
  WORKING_DIRECTORY "/home/robot/bebop_ws/devel/src/ARSDKBuildUtils"
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 ARSDK3_version_3_6
  WORKING_DIRECTORY "/home/robot/bebop_ws/devel/src/ARSDKBuildUtils"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/ARDroneSDK3/ARSDKBuildUtils.git'")
  endif()
